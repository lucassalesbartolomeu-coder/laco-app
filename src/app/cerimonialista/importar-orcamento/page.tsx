      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <motion.div {...fadeUp} transition={{ delay: 0.05 }} className="space-y-4">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-5">
            ...
            {/* Camera — primary CTA on mobile */}
            {!file && (
              <label className="mt-3 flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-midnight text-white font-body text-sm cursor-pointer hover:bg-midnight/90 transition lg:hidden">
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                Fotografar orçamento
                <input
                  type="file"
                  accept="image/*"
                  capture="environment"
